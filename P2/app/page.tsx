...
import { Zap, User, Briefcase, Wallet, LogOut, Database, Link } from "lucide-react"
        ...
        <div className="max-w-md w-full">
          <div className="flex flex-col items-center gap-6 text-center">
            ...
            <div>
              ...
              <p className="text-sm text-primary font-medium mt-1">Automated Renewal Companion</p>
              <p className="text-muted-foreground mt-2">AI-powered renewal management with blockchain verification</p>
            </div>
            ...
            <div className="w-full p-4 rounded-xl bg-card border border-border">
              ...
              <div className="grid grid-cols-2 gap-2">
                <button
                  ...
                  className={`flex items-center justify-center gap-2 p-3 rounded-lg border transition-all ${dataMode === "csv"
                ...
                <button
                  ...
                  className={`flex items-center justify-center gap-2 p-3 rounded-lg border transition-all ${dataMode === "blockchain"
                      ? "bg-primary text-primary-foreground border-primary"
                      : "bg-background border-border hover:border-primary/50"
                    }`}
                >
        ...
        <div className="max-w-4xl mx-auto">
          <header className="flex items-center justify-between py-4 mb-12">
            <div className="flex items-center gap-3">
              ...
              <div>
                <span className="font-semibold text-lg">ARC</span>
                <span className="text-xs text-muted-foreground ml-2">Automated Renewal Companion</span>
              </div>
            </div>
            <div className="flex items-center gap-3">
              <div className="flex items-center gap-1 p-1 rounded-lg bg-secondary">
                <button
                  onClick={() => setDataMode("csv")}
                  className={`flex items-center gap-1.5 px-3 py-1.5 rounded-md text-sm transition-all ${dataMode === "csv" ? "bg-background shadow-sm text-foreground" : "text-muted-foreground"
                    }`}
                >
                ...
                <button
                  onClick={() => setDataMode("blockchain")}
                  className={`flex items-center gap-1.5 px-3 py-1.5 rounded-md text-sm transition-all ${dataMode === "blockchain" ? "bg-background shadow-sm text-foreground" : "text-muted-foreground"
                    }`}
                >
          ...
          <div className="flex items-center gap-6">
            <div className="flex items-center gap-3">
              ...
              <div>
                ...
                <span className="text-xs text-muted-foreground ml-1 hidden sm:inline">Automated Renewal Companion</span>
              </div>
            </div>
